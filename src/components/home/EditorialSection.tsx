...
export function EditorialSection() {
  return (
    <section className="relative py-16 md:py-24 lg:py-32 bg-obsidian overflow-hidden border-t border-border/40">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-1/2 left-0 -translate-y-1/2 w-125 h-125 bg-gold/5 blur-[140px] rounded-full"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-0 right-1/4 w-100 h-75 bg-gold/5 blur-[100px] rounded-full"
      />
      ...
      <div className="container-torquens relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          {/* ───────────────────────────────────────────────────────────── */}
          {/* 1. MEDIA STAGE (Left — Asymmetric Cinematic Frame)            */}
          {/* ───────────────────────────────────────────────────────────── */}
          <div className="lg:col-span-6 order-2 lg:order-1 relative group">
            {/* Outer Decorative Gold Wireframe Rings */}
            <div
              aria-hidden="true"
            ...
            <div className="relative aspect-4/3 sm:aspect-16/10 overflow-hidden rounded-xl border border-border/80 shadow-card bg-charcoal">
              ...
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-auto sm:max-w-xs">
                <div className="rounded-lg bg-graphite/80 backdrop-blur-xl border border-white/8 p-4 shadow-dropdown">
            ...
            {/* Floating Provenance Stat Card (Desktop) */}
          ...
          {/* ───────────────────────────────────────────────────────────── */}
          {/* 2. EDITORIAL NARRATIVE (Right — Typography Hierarchy)         */}
          {/* ───────────────────────────────────────────────────────────── */}
          <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-normal tracking-tight text-primary leading-[1.1]">
              The Art of{' '}
              <span className="text-gold-gradient">Automotive Excellence</span>
            </h2>

            {/* Body Copy */}
            <div className="space-y-4 text-secondary font-sans text-sm sm:text-base leading-relaxed max-w-xl">
              <p>
                At TORQUENS, we believe that exceptional vehicles are more than just
                transportation—they are expressions of engineering artistry, design
                mastery, and the relentless pursuit of perfection.
              </p>
              <p>
                Our editorial desk explores the stories behind the cars that define
                automotive culture, from heritage icons and factory race cars to the
                latest innovations reshaping the future of mobility.
              </p>
            </div>

            {/* Micro Spec Highlights */}
